...
function Tv() {
    const {data, isLoading} = useQuery<IGetPopularTv>(["movies", "nowPlaying"], getTvShow);
    ...
    const clickedTvShows = bigTvMatch?.params.tvId && data?.results.find((tv) => tv.id === +bigTvMatch.params.tvId!);
    return (
        <Wrapper>
            {isLoading ? (
